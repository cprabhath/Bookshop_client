...
export default function Profile() {
  ...
  const stats = [
    { icon: BookOpen, label: 'Books Read', value: profile.booksRead },
    { icon: Heart, label: 'Favorite Genres', value: profile.favoriteGenres.length },
    { icon: Clock, label: 'Reading Goal', value: `${profile.booksRead}/${profile.readingGoal}` }
  ];
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div className="relative h-48">
              <div className="absolute inset-0">
                <img src="https://gobookmart.com/wp-content/uploads/2022/05/8-Most-Anticipated-Books-Releasing-in-June-2022-1140x641.jpg" alt="" />
              </div>
